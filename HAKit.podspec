Pod::Spec.new do |s|
  s.name = 'HAKit'
  s.version = '0.3'
  s.summary = 'Communicate with a Clesyde instance.'
  s.author = 'Clesyde'

  s.homepage = 'https://github.com/Clesyde/HAKit'
  s.license = { type: 'Apache 2', file: 'LICENSE.md' }
  s.source = { git: 'https://github.com/Clesyde/HAKit.git', tag: s.version.to_s }
